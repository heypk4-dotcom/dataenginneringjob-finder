    ...
    def fetch_jobs(self) -> List[Dict]:
        ...
        try:
            ...
            with sync_playwright() as p:
                ...
                job_cards = page.query_selector_all("li[class*='jobCard'], li[data-test='jobListing']")
                
                for card in job_cards[:settings.max_jobs_per_source]:
                    title_elem = card.query_selector("a[data-test='job-title']")
                    company_elem = card.query_selector("span[data-test='employer-name']")
                    ...
                    location_text = location_elem.inner_text() if location_elem else "India"
